    ...
    <div className={classes.form}>
      <form>
        <div className={classes.firstName}>
          <Label className={classes.labell} text={"Name"} />
          <InputBox
            type={"text"}
            onChange={(e) => {
        ...
        <div className={classes.firstName}>
          <Label className={classes.labell} text={"Email"} />
          <InputBox
            type={"email"}
            placeholder={"email"}
            onChange={(e) => {
        ...
        <div className={classes.firstName}>
          <Label className={classes.labell} text={"Phone number"} />
          <InputBox
            type={"text"}
        ...
        <div className={classes.firstName}>
          <Label className={classes.labell} text={"Message"} />
          <InputBox
            type={"text"}
